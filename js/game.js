...
Game.displayLevelLink = function () {
    ...
    var wateraction = function () {
        ...
        //Dynamic access to checkpoint numbers
    ...
    //	When the mouse leaves the dots, select returns the selected level
    var dest = cur.position().left;
    var t = 0.4;
    dest -= 50 * (Game.LEVEL - 1);
    $('.dots').mouseleave(function () {
        ...
        //	After selecting the level, water drops stay at the corresponding level
